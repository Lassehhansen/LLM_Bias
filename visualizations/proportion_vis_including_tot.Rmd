---
title: "Visualizations Vis Including Tot"
subtitle: "LLM Bias"
...
p1_stacked_bar = ggplot(data = df_gender_tot3_perc, aes(x = medical_key, y = data_perc, fill = keyword)) +
  ...
  scale_fill_manual(values = rev(c("#344e41", "#9b2226", "#DCDBA8")),
                    labels = c("No Demographic Mention", "Female", "Male")) +
  coord_flip() +
    theme_classic() +
  theme(legend.position = "bottom",
        ...
        plot.margin = unit(c(0.5, 2.5, 0.2, 0.2), 'lines'),
...
p2_stacked_bar = ggplot(data = df_racial_tot3_perc, aes(x = medical_key, y = data_perc, fill = keyword)) +
  ...
  scale_fill_manual(values=rev(c("#bc6c25", "#344e41", "#540b0e", "#9b2226", "#03045e", "#0077b6", "#DCDBA8")),
                    labels = c("No Demographic Mention", "White", "Black", "Asian", "Hispanic", "Native", "Pac. Islander")) +
  coord_flip() +
  theme_classic() +
  theme(legend.position = "bottom",
        strip.text.y.left = element_text(angle = 0),
...
```{r}
png(filename = "figures_manuscript/tot_both.png", width = 3000, height = 2000, units = "px", res = 300)
...
ggsave("figures_manuscript/tot_both.eps",  width = 2500, height = 2000, units = "px", dpi = 300)
...
p1_stacked_bar_source = ggplot(data = df_gender_tot3_perc, aes(x = medical_key, y = data_perc, fill = keyword)) +
  ...
  labs(title = "A. Gender",
       ...
       fill = "") +
scale_fill_manual(values = rev(c("#344e41", "#9b2226", "#DCDBA8")),
                    labels = c("No Demographic Mention", "Female", "Male")) +  facet_grid(. ~ reorder(facet_label, -total_count)) +
...
```{r}
png(filename = "figures_manuscript/source_tot_both.png", width = 3500, height = 2500, units = "px", res = 300)
...
ggarrange(p1_stacked_bar_source, p2_stacked_bar_source,
          nrow = 2)
ggsave("figures_manuscript/source_tot_both.eps",  width = 3500, height = 2500, units = "px", dpi = 300)
